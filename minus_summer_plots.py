...
def big_loop(stel, gas, stel_err, gas_err, mass, name):
    ...
    plt.title("DRPall PA - Stellar Position Angle vs Galaxy Mass")
    plt.ylabel("DRPall PA - Stellar PA")
...
def big_loop2(stel, gas, stel_err, gas_err, mass, name):
    ...
    plt.title("GAS Position Angle - DRPall Position Angle vs DRPall b/a")
    plt.ylabel("DRPall PA - Gas PA")
    plt.xlabel('DRPALL b/a ratio')
    #plt.ylim(-1.75, 180)
    #plt.xlim(8.5, 11.5)
...
def big_loop3(stel, gas, stel_err, gas_err, mass, name):
    minus = np.absolute(stel - gas)
    ...
    plt.title("Stellar Position Angle - Gas Position Angle vs DRPall b/a")
    plt.ylabel("Stellar PA - Gas PA")
    plt.xlabel('Log Galaxy Mass')
    plt.ylim(-1.75, 180)
    plt.xlim(8.5, 11.5)
...
big_loop2(gas, pa, stel_err, 0, bovera, 'stel-gas_vs_b_a')

big_loop3(gas, stel, gas_err, stel_err, mass, 'stel-gas_vs_mass')

big_loop(pa, gas, 0, gas_err, mass, 'drpallpa-gas_vs_mass')
