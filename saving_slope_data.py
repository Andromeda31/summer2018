...
#Sum the fluxes over a 3" center of the galaxy, put into is starforming
        ...
        fits_filename = fits.util.get_testdata_filepath('/home/celeste/Documents/astro_research/summer_2018/slopes_summer2018.fits')
        
        
        c1 = fits.Column(name = 'Plate ID', array = plateifu, format = '20A')
        c2 = fits.Column(name = 'Expected Slope', array = slope_expected, format = 'E')
        c3 = fits.Column(name = 'Calculated Slope', array = slope_calculated, format = 'E')
        cols = fits.ColDefs([c1, c2, c3])
        tbhdu = fits.BinTableHDU.from_columns(cols)

        tbhdu.writeto('/home/celeste/Documents/astro_research/summer_2018/slopes_summer2018.fits')
        asdfsad
        continue
